...
namespace IP_Projekt.Migrations
{
    ...
    [Migration("20220906185358_register")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IP_Projekt.DB.Models.Wizyta", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("lekarzId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("lekarz_id");

                    b.Property<string>("opisObjawow")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("opis_objawow");

                    b.Property<string>("pacjentId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("pacjent_id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("IP_Projekt.DB.Models.User", null)
                        .WithMany()
